...
describe('2. Teste da rota /chat:', () => {
  afterEach(() => {
    sinon.restore();
  });

  it(`2.1. GET em "/chat/user/:id/all", deve retornar status 200 e body com os dados das 
  ...
  it(`2.2. POST em "/chat/new/:id", contendo a chave messages com um array e a rota com um 
  id válido, deve salvar as mensagens e retornar status 201 e body com os dados das 
